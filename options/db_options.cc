...
ImmutableDBOptions::ImmutableDBOptions(const DBOptions& options)
    : enable_spdklogging(options.enable_spdklogging),
      transactional_mode(options.transactional_mode),
      ssdlogging_num(options.ssdlogging_num), 
      ssdlogging_path(options.ssdlogging_path),
      ssdlogging_type(options.ssdlogging_type),
      spdk_recovery(options.spdk_recovery),
      last_logging_lpn(options.last_logging_lpn),
      logging_server_num(options.logging_server_num),
      before_server_num(options.before_server_num),
      after_server_num(options.after_server_num),
      spandb_worker_num(options.spandb_worker_num),
      max_read_que_length(options.max_read_que_length),
